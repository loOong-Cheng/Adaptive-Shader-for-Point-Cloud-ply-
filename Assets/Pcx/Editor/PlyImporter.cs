...
namespace Pcx
{
    ...
    class PlyImporter : UnityEditor.AssetImporters.ScriptedImporter
    {
        ...
        enum DataProperty {
            ...
            SingleXNormal, SingleYNormal, SingleZNormal,
            DoubleX, DoubleY, DoubleZ,
            DoubleXNormal, DoubleYNormal, DoubleZNormal,
        ...
        static int GetPropertySize(DataProperty p)
        {
            switch (p)
            {
                ...
                case DataProperty.SingleXNormal: return 4;
                case DataProperty.SingleYNormal: return 4;
                case DataProperty.SingleZNormal: return 4;
                case DataProperty.DoubleX: return 8;
                case DataProperty.DoubleY: return 8;
                case DataProperty.DoubleZ: return 8;
                case DataProperty.DoubleXNormal: return 8;
                case DataProperty.DoubleYNormal: return 8;
                case DataProperty.DoubleZNormal: return 8;
            ...
            for (var skip = false;;)
            {
                ...
                if (col[0] == "property")
                {
                    ...
                    switch (col[2])
                    {
                        ...
                        case "nx"   : prop = DataProperty.SingleXNormal; break;
                        case "ny"   : prop = DataProperty.SingleYNormal; break;
                        case "nz"   : prop = DataProperty.SingleZNormal; break;
                    }
                             ...
                             col[1] == "int32" || col[1] == "uint32" || col[1] == "float32")
                    {
                        // switch (prop)
                        // {
                        //     case DataProperty.DoubleXNormal: prop = DataProperty.
                        // }
                        if (prop == DataProperty.Invalid)
                             ...
                             col[1] == "double" || col[1] == "float64")
                    {
                        switch (prop)
                        {
                            ...
                            case DataProperty.SingleXNormal: prop = DataProperty.DoubleXNormal; break;
                            case DataProperty.SingleYNormal: prop = DataProperty.DoubleYNormal; break;
                            case DataProperty.SingleZNormal: prop = DataProperty.DoubleZNormal; break;
                        }
            ...
            for (var i = 0; i < header.vertexCount; i++)
            {
                foreach (var prop in header.properties)
                {
                    switch (prop)
                    {
                        ...
                        case DataProperty.SingleXNormal: xn = (float)reader.ReadSingle(); break;
                        case DataProperty.SingleYNormal: yn = (float)reader.ReadSingle(); break;
                        case DataProperty.SingleZNormal: zn = (float)reader.ReadSingle(); break;

                        case DataProperty.DoubleXNormal: xn = (float)reader.ReadDouble(); break;
                        case DataProperty.DoubleYNormal: yn = (float)reader.ReadDouble(); break;
                        case DataProperty.DoubleZNormal: zn = (float)reader.ReadDouble(); break;
                ...
                if (i==0)
                {
                    Debug.Log("Test Normal is:"+zn);
                }
                data.AddPoint(x, y, z, r, g, b, a, xn, yn, zn);
            }
